...
// because const type is immutable
...
console.log(2 + "3");
console.log(2 + 3);
// JavaScript turns any + to string concatenation if one of the operand was a string
...
console.log(a);
//console.log(b);
// the scope of let is inside the block it was decalred in
